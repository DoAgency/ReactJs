...
function ListaDipendentiFunc(props: Props) {

    return (
        <div>
            <h2>Lista dipendenti nel component child:</h2>

            {props.listaDipendenti?.map((item, index) => (
...
export default ListaDipendentiFunc;